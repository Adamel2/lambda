...
public class StandardFunctionalInterfaceExample {
  ...
  public static void main(String[] args) {
    ...
    printLastNameWithCondition(people, p -> true, p -> System.out.println(p));
//    printLastNameWithCondition(people , p -> !p.getLastName().isEmpty());

    // print a people that have last name beginning with A

    System.out.println("Condition....!");
    printLastNameWithCondition(
        people, p -> p.getLastName().startsWith("A"), p -> System.out.println(p));
  }

  private static void printLastNameWithCondition(List<Person> people , Predicate<Person> predicate , Consumer<Person> consumer) {
